...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://pancakeswap.finance/images/tokens/${token.address[250]}.svg`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://pancakeswap.finance/images/tokens/${token.address[250]}.svg`;
        const secondarySrc = `https://pancakeswap.finance/images/tokens/${tokens[randomTokenIndex].address[250]}.svg`;
